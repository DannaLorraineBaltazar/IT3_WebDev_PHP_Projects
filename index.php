...
$monthly_salary = (float)($_GET['salary'] ?? 82500.50);
$loan_amount = (float)($_GET['loan'] ?? 32000.50);;
$years_to_pay = (int)($_GET['years'] ?? 5);

$total_interest = $loan_amount * 0.05 * $years_to_pay;

$gross_loan = $loan_amount + $total_interest + PROCESSING_FEE;

$monthly_amortization = $gross_loan / ($years_to_pay * 12);

$tax_deduction = $monthly_salary * TAX_RATE;
$net_take_home = $monthly_salary - $tax_deduction - $monthly_amortization;


$treshold_check = $monthly_amortization <=> ($monthly_salary * 0.30);

if(1000 == "1000") {
    $identity_check = "TRUE (Identical)";
} else {
    $identity_check = "FALSE (Not Identical)";
}
?>
    ...
    <div class="dashboard-container">
        ...
        <div class="info-grid">
            ...
            <div class="data-card">
                ...
                <span class="value" style="color: var(--error);">
                    <?php echo "₱" . number_format($monthly_amortization, 2) ?>
                </span>
            </div>
        </div>
        ...
        <div class="audit-panel">
            <div class="audit-line">
                <span class="audit-key">SPACESHIP_OP:</span> <?php echo $treshold_check; ?>
            </div>
            <div class="audit-line">
                <span class="audit-key">IDENTITY_VALIDATION:</span> <?php echo $identity_check; ?>
            </div>
